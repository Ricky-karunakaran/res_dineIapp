...
public class BillItem {
    ...
    public double getBillItemPrice() { return this.bill_item_quantity*this.bill_item_unit_price;}
    ...
    public void updateBillItem(){
        try{
            String sql = "Update  bill_item set bill_item_quantity = ?, bill_item_status=? WHERE bill_item_id = ?";
            Connection con = dbConnection.getDb();
            PreparedStatement pt = con.prepareStatement(sql);
            pt.setInt(1, this.bill_item_quantity);
            pt.setString(2,this.bill_item_status);
            pt.setString(3, this.bill_item_id);
    ...
    public void updateQuantity (int quantity){
        if(this.bill_item_quantity == 0){
        } else {
            this.bill_item_quantity = this.bill_item_quantity + quantity;
        }
    }
}
